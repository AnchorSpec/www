...
Configure AnchorSpec to generate artifacts in languages other than English.

## Quick Setup

Add a language instruction to your `anchorspec/config.yaml`:
...
anchorspec instructions proposal --change my-change
